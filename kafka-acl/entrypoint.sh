...
touch kafka.log
sudo -E -u runuser JMX_PORT=9999 KAFKA_OPTS="-Djava.security.auth.login.config=/kafka_server_jaas.conf"  kafka/bin/kafka-server-start.sh kafka/config/server.properties
tail -f kafka.log